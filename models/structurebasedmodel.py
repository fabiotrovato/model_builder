...
class StructureBasedModel(Model):
    ...
    def __init__(self, topology, bead_repr=None):
        ...
        """
        print "structurebasedmodel.py:" 
        
        Model.__init__(self, topology, bead_repr=bead_repr)
        self.Hamiltonian = potentials.StructureBasedHamiltonian()
        #self.mapping.add_atoms()  #commented FABIO
        self.atomtype_dictbyname = {}
        self.mapping.add_atoms2()
    ...
    def assign_types(self,atomtype_dictbyname):
        self.mapping.add_atmtypes(atomtype_dictbyname)
